...
'set fwrite /stornext/online6/assim_dados/gdad/eval_SMG_2.0.0/dados_temp_mauro/'name'.bin'
say 'set fwrite /stornext/online6/assim_dados/gdad/eval_SMG_2.0.0/dados_temp_mauro/'name'.bin'
